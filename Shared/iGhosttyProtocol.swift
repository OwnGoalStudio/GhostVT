...
/// Wire contract shared by the app and `ighosttyd`.
///
...
enum iGhosttyProtocol {
    static let version: UInt64 = 1
    static let serviceName = "wiki.qaq.ighostty.service"
    static let clientEntitlement = "wiki.qaq.ighostty.client"
    ...
    static let clientPaths = [
        "/Applications/iGhostty.app/iGhostty",
    ]
...
enum iGhosttyOperation: UInt64, Sendable {
    case hello = 1
    case listSessions = 2
    case openSession = 3
...
enum iGhosttyEvent: UInt64, Sendable {
    case output = 100
    case sessionExit = 101
}

enum iGhosttyReplyCode: Int64, Sendable {
    case success = 0
...
struct iGhosttyFailure: Error, Equatable, Sendable {
    var code: iGhosttyReplyCode
    var message: String

    init(_ code: iGhosttyReplyCode, _ message: String) {
        self.code = code
